...
This script is design for paired end Illumina sequencing reads.

use : python featureCount_PE.py     iMerge (input file with 
...
mmr = float(iBAM.mapped)/float(2)/float(1000000)
...
for line in iMerge:
    ...
    if gene not in gene_name:
        ...
        if len(gene_name)==0:
            ...
            print(str(gene_output)+' thrown out')
